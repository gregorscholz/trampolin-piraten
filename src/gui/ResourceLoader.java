...
public class ResourceLoader {
    ...
    private static BufferedImage background, fass_explosion, fass_rum, fass_wellenstand_erhoehen, fass_wellenstand_verringern, fass_munition, fass, kugel, wellen, himmel, schiff;
    ...
    public void loadSchiff() {
        try {
            schiff = ImageIO.read(new File("resources/schiff.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    public static BufferedImage getSchiff() {
        return schiff;
    }
