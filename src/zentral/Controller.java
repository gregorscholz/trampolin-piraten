...
public abstract class Controller {
	 ...
	 * 
	 * wenn bei der plattform �berpr�ft wird, ob die plattform noch im spielfeld ist, dann wird diese methode wegfallen
	 * 
	...
	/**
	 * �bergibt die Tasteneinstellung an die Steuerungsklasse.
	 * 
	 * @author Ines Rohrbach
	 */
